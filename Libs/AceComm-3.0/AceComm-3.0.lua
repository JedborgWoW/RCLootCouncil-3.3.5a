...
function AceComm:RegisterComm(prefix, method)
	...
	-- WotLK 3.3.5a: no hard 16-char prefix limit (the old AceComm had no
	-- such check). Removed to prevent error() spam from other addons that
	-- share this AceComm instance (AtlasLoot, SpecializedAbsorbs, etc.).
	if C_ChatInfo then
